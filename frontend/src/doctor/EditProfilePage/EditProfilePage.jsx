...
export default function EditProfilePage({ apiBase }) {
  ...
  const API_BASE = `${(import.meta.env.VITE_BACKEND_URL || "https://healbook-backend.onrender.com").replace(/\/$/, "")}/api/doctors`;
  ...
  useEffect(() => {
    ...
    async function fetchDoctor() {
      try {
        ...
        d.imageUrl = d.imageUrl || d.image || d.avatar || "";
        if (!cancelled) {
          setDoc(d);
