...
import { testimonialStyles, toastStyles } from "../../assets/dummyStyles";
  ...
  return (
    <section className={testimonialStyles.container}>
      <div className={testimonialStyles.headerContainer}>
        <h2 className={testimonialStyles.title}>What People Say</h2>
        <p className={testimonialStyles.subtitle}>
          Read feedback from patients who visited our facility and medical professionals who use our services
        </p>
      </div>
      ...
      <div className={testimonialStyles.grid}>
        ...
        >
          ...
          >
            {[...leftTestimonials, ...leftTestimonials, ...leftTestimonials].map((t, idx) => (
              <TestimonialCard key={t.id + "-" + idx} testimonial={t} direction="left" />
            ))}
          </div>
        </div>
        ...
        >
          ...
          <div
            ...
            className={testimonialStyles.scrollContainer}
          >
            {[...rightTestimonials, ...rightTestimonials, ...rightTestimonials].map((t, idx) => (
              <TestimonialCard key={t.id + "-" + idx} testimonial={t} direction="right" />
            ))}
          </div>
        </div>
      </div>
