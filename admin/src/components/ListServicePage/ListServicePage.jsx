      ...
      <div className={s.headerContainer}>
        ...
        <div className="flex flex-wrap items-center gap-2 mt-4 md:mt-0">
          <button
            ...
            className={`px-3.5 py-1.5 text-xs font-semibold rounded-full shadow-xs transition cursor-pointer ${
              viewMode === "list"
                ? "bg-emerald-600 border border-transparent text-white font-semibold"
          ...
          <button
            ...
            className={`px-3.5 py-1.5 text-xs font-semibold rounded-full shadow-xs transition flex items-center gap-1 cursor-pointer ${
              viewMode === "add"
                ? "bg-emerald-600 border border-transparent text-white font-semibold"
                : "bg-white border border-slate-200 text-slate-600 hover:bg-slate-50"
            }`}
