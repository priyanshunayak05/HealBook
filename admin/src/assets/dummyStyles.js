...
export const navbarStyles = {
  // Layout styles
  header: "sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-100 shadow-sm font-serif",
  navContainer: "relative mx-auto max-w-7xl lg:px-7 xl:px-2 px-4 py-3",
  ...
  centerNavContainer: "hidden lg:flex items-center justify-center relative flex-1 min-w-0 mx-6",
  glowEffect: "glow relative rounded-3xl p-0.5 bg-linear-to-r from-emerald-100 via-emerald-200 to-emerald-100 w-full max-w-4xl",
  centerNavInner: "relative flex items-center w-full",
  centerNavScrollContainer: "center-inner relative whitespace-nowrap rounded-3xl bg-white/95 lg:px-2 px-3 py-1.5 flex items-center gap-1.5 shadow-md border border-gray-100 overflow-x-auto w-full",
  ...
  mobileMenuContainer: "absolute top-full left-4 right-4 z-50 mt-1 lg:hidden shadow-2xl",
  mobileMenuInner: "rounded-2xl bg-white shadow-2xl p-4 space-y-2 border border-slate-100/90 animate-fadeIn",
